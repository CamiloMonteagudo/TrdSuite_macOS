...
+(bool) LoadConjLang:(int) lng
  ...
  CVerb->SetDataPath( _DictPath );                                          // Pone el camino a los diccionarios
...
bool OpenRedAPI( int lng )
  ...
  Red->SetDataPath( _DictPath );                            // La pone el camino a los diccionarios
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
static CGFloat FontSize = [NSFont systemFontSize];
...
static NSFont* fontConjSmallItalic = [NSFont systemFontOfSize: 0.7 *FontSize];
static NSFont* fontConjBoldMid     = [NSFont boldSystemFontOfSize: 0.85*FontSize];
